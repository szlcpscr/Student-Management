...
from .models import Upload, Student, New, Grade, Course, Program, Exam_deadline
...
class UploadFormFile(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(UploadFormFile, self).__init__(*args, **kwargs)
...
class SelectTeachersForm(forms.ModelForm):
    ...
    def __init__(self, ):
        super(SelectTeachersForm, self).__init__(*args, **kwargs)
...
class AfatetForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(AfatetForm, self).__init__(*args, **kwargs)
