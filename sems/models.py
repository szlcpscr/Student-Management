...
class Exam_deadline(models.Model):
...
class Exams(models.Model):
    ...
    afati = models.ForeignKey(Exam_deadline, on_delete=models.CASCADE, null=True)
...
class Profile(models.Model):
    ...
    role = models.ForeignKey(User_type, default=1, on_delete=models.CASCADE)
